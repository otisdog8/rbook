...
import 'package:rbook/views/viewers/ui/toolbar_button.dart';
import 'package:rbook/views/viewers/ui/toolbar_page_number.dart';
...
class ReaderToolbarState extends State<ReaderToolbar> {
  ...
  Widget _firstRow(BuildContext context) {
    ...
    return Row(
      children: <Widget>[
        ToolbarButton(
          asset: 'packages/rbook/assets/images/ic_skip_left_white_24dp.png',
        ...
        const SizedBox(width: 8.0),
        ToolbarButton(
          asset: 'packages/rbook/assets/images/ic_skip_right_white_24dp.png',
